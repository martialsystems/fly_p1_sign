...
W is hop-1 signed synapses onto type `pC1_*` with `fruDsx` coexpress, from DA1 PNs, LC10a, VA1v PNs, and putative_ppk23. Scale so max |named signed| onto P1 equals 1.8. Motor scaffolding is schema. Not a 166,691-cell LIF.
